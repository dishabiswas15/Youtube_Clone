  ...
  return (
    <div>
      ...
      <div className="flex">
        {isLiked ? (
          <button
            className="flex my-6 bg-slate-200 py-2 px-8 rounded-l-lg w-24 h-10 "
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-6 h-6 scale-150 duration-300 text-red-500"
            >
          ...
          <button
            className="flex my-6 bg-slate-200 p-2 rounded-l-lg w-24 h-10"
